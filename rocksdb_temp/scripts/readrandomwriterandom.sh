...
../cmake-build-debug/db_bench --benchmarks="readrandomwriterandom" --use_existing_db=true --db="/tmp/db" --num_column_families=5 \
...
--readwritepercent=90 --cache_size=1048576  \
--num=1000000 -trace_file="/tmp/op_trace_file_dbbench"
